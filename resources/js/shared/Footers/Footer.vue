<template>
    <footer class="py-12 default-gradient">
        <div class="grid grid-cols-1 justify-items-center">
            <div class="flex flex-col w-full items-center">
                <div class="flex items-center my-4">
                    <a href="https://github.com/muarachmann"
                       target="_blank"
                       class="flex items-center justify-center w-8 h-8 p-1 border rounded-full bg-white hover:text-white hover:border-black hover:bg-white border-stroke dark:border-dark-2 dark:hover:border-primary dark:text-white hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                    ...
                    <a href="https://x.com/muarachmann"
                       target="_blank"
                       class="flex items-center justify-center w-8 h-8 p-1 border rounded-full bg-white hover:text-white hover:border-black hover:bg-white border-stroke dark:border-dark-2 dark:hover:border-primary dark:text-white hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                    ...
                    <a href="https://www.linkedin.com/in/muarachmann"
                       target="_blank"
                       class="flex items-center justify-center w-8 h-8 p-1 border rounded-full bg-white hover:text-white hover:border-black hover:bg-white border-stroke dark:border-dark-2 dark:hover:border-primary dark:text-white hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                ...
                <p class="text-base text-body-color dark:text-dark-2">
                    With ❤️ and ☕️ by <a href="https://muarachmann.com" target="_blank" class="text-theme-1 font-bold hover:underline">@muarachmann</a>
                </p>
                <div class="flex px-4 py-1.5 items-center rounded text-black text-sm font-bold justify-center">
                    &copy; {{ new Date().getFullYear() }}
                    <inertia-link class="underline px-1" :href="route('guest.index')">
                        {{ $page.props.app_name }} - {{ $page.props.app_version }}
                    </inertia-link>
                </div>
            </div>
        </div>

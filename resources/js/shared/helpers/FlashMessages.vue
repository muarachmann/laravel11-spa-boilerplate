<template>
    <div class="mx-4 z-9999">
                ...
                <div class="w-full mr-2 mb-4 mt-1 right-2">
                    <div :class="getFlashClass(item.type)" class="relative w-auto flex flex-row items-center p-4 font-semibold tracking-tighter mr-4 shadow-md">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-1 text-xs break-words" v-html="item.text"/>
                        </div>
                    </div>
                </div>
            </template>
        ...
        <notifications group="call" position="bottom right">
            <template slot="body" slot-scope="{ item }">
                <div class="w-full mr-2 mb-4 mt-1 right-2">
                    <div class="bg-white text-gray-800 relative w-auto flex flex-row items-center p-4 font-semibold tracking-tighter mr-4 shadow-lg rounded-md">
                        <div>
                            <h2 class="font-bold text-sm underline" v-html="item.title"/>
                            <div class="mt-1 text-xs break-words" v-html="item.text"/>
                        </div>
